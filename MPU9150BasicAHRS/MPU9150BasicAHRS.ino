// Læs datablad på magnetometre og ændre config
...
#define WHO_AM_I_AK8975A 0x0B // should return 0x48
...
#define MPU9150_ADDRESS 0x68  // Device address when ADO = 1
#define AK8975A_ADDRESS 0x1E //  Address of magnetometer
...
// Pin definitions
int intPin = 22;  // These can be changed, 2 and 3 are the Arduinos ext int pins
...
void setup()
{
  ...
  Serial.print ("Who am I ");Serial.println(c);
